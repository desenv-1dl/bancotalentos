...
L.Control.FuseSearchCustom = L.Control.FuseSearch.extend({
     /*
    ...
    */
    ...
    createResultItem: function(props, container, popup) {
        ...
        //this._map.fitBounds(props._feature.geometry.coordinates);
    ...
    _panAndPopup : function(feature, popup) {
        ...
        var objGeoJson = new L.GeoJSON(feature, {
            style: function (feature) {
                return {color: '#666'};
            },
            onEachFeature: function (feature, layer) {
                //layer.bindPopup('GAGAG');
                //layer.openPopup();
                objetoSelecionado = layer;
            }
        });
        ...
        //console.log(feature);
        //this._map.fitBounds(feature.geometry.coordinates);
        this._map.fitBounds([
            objGeoJson.getBounds()
        ]);
        //objetoSelecionado.openPopup();
        //this._map.bringToFront()
...
L.control.fuseSearchCustom = function(options) {
    return new L.Control.FuseSearchCustom(options);
};
